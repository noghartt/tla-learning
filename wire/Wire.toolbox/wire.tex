...
\fl{}\moduleLeftDash\cl{ {\MODULE} wire}\moduleRightDash\cl{}
\fl{ {\EXTENDS} TLC ,\, Integers}
\fl{}
\fl{ People \.{\defeq} \{\@w{alice} ,\,\@w{bob} \}}
\fl{ Money \.{\defeq} 1 \.{\dotdot} 10}
\fl{ NumTransfers \.{\defeq} 2}
\fl{}
\fl{ {\p@mmalgorithm} wire}
\fl{ {\p@variables}}
\fl{ acct \.{\in} [ People \.{\rightarrow} Money ]}
\fl{}
\fl{ {\p@define}}
\fl{ NoOverdrafts \.{\defeq}}
\fl{ \A\, p \.{\in} People \.{:}}
\fl{ acct [ p ] \.{\geq} 0}
\fl{ {\p@end} {\p@define} {\p@semicolon}}
\fl{}
\fl{ {\p@process} wire \.{\in} 1 \.{\dotdot} NumTransfers}
\fl{ {\p@variable}}
\fl{ amnt}\al{19}{1}{ \.{\in}}\al{19}{2}{ 1 \.{\dotdot} 5 {\p@semicolon}}
\fl{ from}\al{20}{1}{ \.{\in}}\al{20}{2}{ People {\p@semicolon}}
\fl{ to \.{\in} People}
\fl{ {\p@begin}}
\fl{ Check\@s{.5}\textrm{:}\@s{3}}
\fl{ {\p@if} acct [ from ] \.{\geq} amnt {\p@then}}
\fl{ Withdraw\@s{.5}\textrm{:}\@s{3}}
\fl{ acct [ from ] \.{:=} acct [ from ] \.{-} amnt {\p@semicolon}}
\fl{ Deposit\@s{.5}\textrm{:}\@s{3}}
\fl{ acct [ to ] \.{:=} acct [ to ] \.{+} amnt {\p@semicolon}}
\fl{ {\p@end} {\p@if} {\p@semicolon}}
\fl{ {\p@end} {\p@process} {\p@semicolon}}
\fl{ {\p@end} {\p@algorithm}%
\@y{%
 ;
}%
}
\fl{}
\fl{ {\VARIABLES} acct ,\, pc}
\fl{}
\fl{}
\fl{ NoOverdrafts \.{\defeq}}
\fl{ \A\, p \.{\in} People \.{:}}
\fl{ acct [ p ] \.{\geq} 0}
\fl{}
\fl{ {\VARIABLES} amnt ,\, from ,\, to}
\fl{}
\fl{ vars \.{\defeq} {\langle} acct ,\, pc ,\, amnt ,\, from ,\, to {\rangle}}
\fl{}
\fl{ ProcSet \.{\defeq} ( 1 \.{\dotdot} NumTransfers )}
\fl{}
\fl{ Init \.{\defeq}}\al{46}{2}{%
\@y{\@s{0}%
 Global variables
}%
}
\fl{ \.{\land} acct \.{\in} [ People \.{\rightarrow} Money ]}
\fl{}
 \fl{ \.{\land}}\al{49}{1}{ amnt}\al{49}{2}{ \.{\in}}\al{49}{3}{ [ 1
 \.{\dotdot} NumTransfers}\al{49}{7}{ \.{\rightarrow}}\al{49}{8}{ 1
 \.{\dotdot} 5 ]}
 \fl{ \.{\land}}\al{50}{1}{ from}\al{50}{2}{ \.{\in}}\al{50}{3}{ [ 1
 \.{\dotdot} NumTransfers}\al{50}{7}{ \.{\rightarrow}}\al{50}{8}{ People ]}
 \fl{ \.{\land}}\al{51}{1}{ to}\al{51}{2}{ \.{\in} [ 1 \.{\dotdot}
 NumTransfers \.{\rightarrow} People ]}
 \fl{ \.{\land}}\al{52}{1}{ pc}\al{52}{2}{ \.{=} [ self \.{\in} ProcSet
 \.{\mapsto}\@w{Check} ]}
\fl{}
 \fl{ Check ( self ) \.{\defeq}}\al{54}{5}{ \.{\land}}\al{54}{6}{ pc [ self ]
 \.{=}\@w{Check}}
 \fl{ \.{\land}}\al{55}{1}{ {\IF}}\al{55}{2}{ acct [ from [ self ] ] \.{\geq}
 amnt [ self ]}
 \fl{ \.{\THEN}}\al{56}{1}{ \.{\land}}\al{56}{2}{ pc \.{'}}\al{56}{4}{
 \.{=}}\al{56}{5}{ [ pc {\EXCEPT} {\bang} [ self ]}\al{56}{12}{
 \.{=}}\al{56}{13}{\@w{Withdraw} ]}
 \fl{ \.{\ELSE}}\al{57}{1}{ \.{\land}}\al{57}{2}{ pc \.{'}}\al{57}{4}{
 \.{=}}\al{57}{5}{ [ pc {\EXCEPT} {\bang} [ self ]}\al{57}{12}{
 \.{=}}\al{57}{13}{\@w{Done} ]}
 \fl{ \.{\land}}\al{58}{1}{ {\UNCHANGED} {\langle} acct ,\, amnt ,\, from ,\,
 to {\rangle}}
\fl{}
 \fl{ Withdraw ( self ) \.{\defeq}}\al{60}{5}{ \.{\land}}\al{60}{6}{ pc [ self
 ] \.{=}\@w{Withdraw}}
 \fl{ \.{\land}}\al{61}{1}{ acct \.{'} \.{=} [ acct {\EXCEPT} {\bang} [ from [
 self ] ] \.{=} acct [ from [ self ] ] \.{-} amnt [ self ] ]}
 \fl{ \.{\land}}\al{62}{1}{ pc \.{'} \.{=} [ pc {\EXCEPT} {\bang} [ self ]
 \.{=}\@w{Deposit} ]}
 \fl{ \.{\land}}\al{63}{1}{ {\UNCHANGED} {\langle} amnt ,\, from ,\, to
 {\rangle}}
\fl{}
 \fl{ Deposit ( self ) \.{\defeq}}\al{65}{5}{ \.{\land}}\al{65}{6}{ pc [ self
 ] \.{=}\@w{Deposit}}
 \fl{ \.{\land}}\al{66}{1}{ acct \.{'} \.{=} [ acct {\EXCEPT} {\bang} [ to [
 self ] ] \.{=} acct [ to [ self ] ] \.{+} amnt [ self ] ]}
 \fl{ \.{\land}}\al{67}{1}{ pc \.{'} \.{=} [ pc {\EXCEPT} {\bang} [ self ]
 \.{=}\@w{Done} ]}
 \fl{ \.{\land}}\al{68}{1}{ {\UNCHANGED} {\langle} amnt ,\, from ,\, to
 {\rangle}}
\fl{}
 \fl{ wire ( self ) \.{\defeq} Check ( self ) \.{\lor} Withdraw ( self )
 \.{\lor} Deposit ( self )}
\fl{}
\fl{}
 \fl{ Terminating \.{\defeq}}\al{73}{2}{ \.{\land}}\al{73}{3}{ \A\, self
 \.{\in} ProcSet \.{:} pc [ self ] \.{=}\@w{Done}}
\fl{ \.{\land}}\al{74}{1}{ {\UNCHANGED} vars}
\fl{}
 \fl{ Next}\al{76}{1}{ \.{\defeq}}\al{76}{2}{ (}\al{76}{3}{ \E\, self \.{\in}
 1 \.{\dotdot} NumTransfers \.{:} wire ( self ) )}
\fl{ \.{\lor} Terminating}
\fl{}
 \fl{ Spec}\al{79}{1}{ \.{\defeq}}\al{79}{2}{ Init \.{\land} {\Box} [ Next ]_{
 vars}}
\fl{}
 \fl{ Termination \.{\defeq} {\Diamond} ( \A\, self \.{\in} ProcSet \.{:} pc [
 self ] \.{=}\@w{Done} )}
\fl{}
\fl{}
\fl{}
